...
import 'package:flutter_gallery/src/view/wrap_or_more/wrap_or_more.dart';
              ...
              child: SizedBox(
                ...
                child: Wrap(
                  ...
                  children: controller.isRendered.value
                      ? [
                          ...children.take(controller.showChildCount.value),
                          if (children.length -
          ...
          return SizedBox(
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                key: rowKey,
                children: [
                  ...children.asMap().map((index, Widget value) {
                    return MapEntry(
                        index,
                        MeasureSize(
                          onChange: (Size size) {
