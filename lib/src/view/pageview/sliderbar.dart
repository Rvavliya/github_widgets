...
import 'package:flutter_gallery/src/view/pageview/multi_circluer.dart';
import 'package:flutter_gallery/src/view/pageview/slider_button.dart';
import 'package:flutter_gallery/src/view/pageview/synction_slider.dart/syncfusion_sliders.dart';
...
class _SliderBarMainState extends State<SliderBarMain> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FxGridView(screens: _slider),
    );
  }
}
